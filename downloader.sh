...
wget clone https://raw.githubusercontent.com/mrayy/WASABI/master/pepperStreamer.sh
wget clone https://raw.githubusercontent.com/mrayy/WASABI/master/run.sh

chmod +x pepperStreamer.sh
chmod +x run.sh
